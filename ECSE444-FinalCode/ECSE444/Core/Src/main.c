...
char buffer[100] = ""; // buffer for COM port
/* USER CODE END PV */
...
#define SAMPLING_FREQUENCY 1000.0 // 10 Hz

#define BALL_START_POS_X 71
#define BALL_START_POS_Y 58
#define TIMESTEP 0.01

#define MAXTIME 30 //max time attribute to the user
